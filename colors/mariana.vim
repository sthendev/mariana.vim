...
hi IncSearch guibg=#4e5a65 ctermbg=240 gui=NONE cterm=NONE
...
hi StatusLineNC guibg=#4e5a65 ctermbg=240 gui=bold cterm=bold
hi VertSplit guifg=#4e5a65 ctermfg=240 gui=NONE cterm=NONE
hi Title guifg=#c695c6 ctermfg=176 gui=bold cterm=bold
hi Visual guibg=#4e5a65 ctermbg=240 gui=NONE cterm=NONE
...
hi FoldColumn guifg=#5fb4b4 ctermfg=73 guibg=#4e5a65 ctermbg=240 gui=NONE cterm=NONE
...
hi Pmenu guibg=#4e5a65 ctermbg=240 gui=NONE cterm=NONE
...
hi CursorColumn guibg=#4e5a65 ctermbg=240 gui=NONE cterm=NONE
...
hi MsgSeparator guibg=#4e5a65 ctermbg=240 gui=bold cterm=bold
hi NormalFloat guibg=#4e5a65 ctermbg=240 gui=NONE cterm=NONE
hi MsgArea gui=NONE cterm=NONE
hi FloatBorder guifg=#4e5a65 ctermfg=240 gui=NONE cterm=NONE
...
hi NvimTreeFolderIcon guifg=#5fb4b4 ctermfg=73 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi BufferInactiveIcon guifg=#a6acb9 ctermfg=145 guibg=#4e5a65 ctermbg=240 gui=NONE cterm=NONE
hi BufferOffset guifg=#a6acb9 ctermfg=145 guibg=#4e5a65 ctermbg=240 gui=NONE cterm=NONE
